...
import com.sujin.nubloompilot.shared.ui.theme.Gray600
...
fun DrawScope.drawTimelineBackground(
    ...
    drawCircle(
        ...
        radius = layout.clockRadius,
        center = layout.circleCenter,
        style = Stroke(width = style.outlineStrokeWidth)
    )
